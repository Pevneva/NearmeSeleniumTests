...
public class OnlineRegistration extends ru.st.selenium.pages.TestBase {
  ...
  public void OnlineRegistr(String ContractType, String PromoCode)throws Exception {
   ...
   //checking that "searchResultList" table contains 'status_pending' class
    ...
    driver.findElement(By.id("companyContactDetails.websiteUrl")).sendKeys("www.website001.com");
    driver.findElement(By.id("companyContactDetails.facebook")).clear();
    driver.findElement(By.id("companyContactDetails.facebook")).sendKeys("www.facebook001.com");
    driver.findElement(By.id("companyContactDetails.twitter")).clear();
    driver.findElement(By.id("companyContactDetails.twitter")).sendKeys("www.twitter001.com");
    driver.findElement(By.id("companyContactDetails.foursquare")).clear();
    driver.findElement(By.id("companyContactDetails.foursquare")).sendKeys("www.foursquare001.com");
    driver.findElement(By.id("companyContactDetails.instagram")).clear();
    driver.findElement(By.id("companyContactDetails.instagram")).sendKeys("www.instagram.com");
    driver.findElement(By.id("companyContactDetails.pinterest")).clear();
    driver.findElement(By.id("companyContactDetails.pinterest")).sendKeys("www.pinterest.com");
    ...
    for (int second = 0;; second++) {
    	if (second >= 60) fail("timeout");
    	try { if (isElementPresent(By.xpath("//div[@class=\"info_details\"]"))) break; } catch (Exception e) {}
    	Thread.sleep(1000);
    }
